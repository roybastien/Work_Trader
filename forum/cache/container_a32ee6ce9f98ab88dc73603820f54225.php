...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), './forum/', 'php', $this->get('path_helper'), $this->get('mimetype.guesser'), $this->get('dispatcher'), $this->get('cache.driver'));
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'root', '784651594', 'Forum', '', false, false);
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './forum/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
