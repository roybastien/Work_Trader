...
*
* @package acp
* @version $Id: acp_rokbb.php 5936 2012-12-14 08:24:00Z karol $
...
class acp_rokbb
{
	...
	function main($id, $mode)
	{
		...
		$error = array();
	  	...
	  	if ($mode !== "global_conf") {
			include($phpbb_root_path."styles".DIRECTORY_SEPARATOR.$mode.DIRECTORY_SEPARATOR."admin".DIRECTORY_SEPARATOR."rokbb_options".".".$phpEx);
		} else {
			include($phpbb_root_path."includes/rokbb/global_conf.".$phpEx);
		}
